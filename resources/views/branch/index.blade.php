...
@section("action-btn")
<a class="btn btn-outline-warning btn-sm rounded-0" href="{{ route('branch.create',) }}">Create Branch</a>
@endsection
    ...
    <tbody>
      ...
      <tr class="align-middle">
        ...
        <td class="d-flex justify-content-between align-items-center px-2">
          ...
          <span class="text-danger">
            <a class="btn btn-primary" href="{{ route('group.show', $branch->id) }}">See All</a>
          </span>
        </td>
      </tr>
      @endforeach
